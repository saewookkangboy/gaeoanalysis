    ...
    if (value.trim()) {
      ...
      try {
        ...
        if (trimmed.match(/^https?:\/\//i)) {
          ...
          const isValidDomain = domainPattern.test(trimmed) || trimmed.match(/^www\./i);
    ...
    <div className="relative flex-1">
      <div className="relative">
        ...
        <input
          ...
          className={`w-full max-w-full md:w-[500px] lg:w-[600px] xl:w-[700px] h-[60px] rounded-lg border-2 ${
            isValid
              ? 'border-gray-200 focus:border-sky-500 focus:ring-4 focus:ring-sky-500/20'
              : 'border-red-300 focus:border-red-500 focus:ring-4 focus:ring-red-500/20'
          } bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 pl-12 pr-4 text-base md:text-xl font-medium shadow-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed`}
          disabled={disabled}
